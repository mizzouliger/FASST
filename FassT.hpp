...
public:
    ...
    int getCalls() {
        return FassTBench::distanceCalls;
    }

    int getNodesVisited() {
        return FassTBench::nodesVisited;
    }
};
...
std::vector<T> FassT<T, distance>::search(const T &target, const double radius) {
    ...
    FassTBench::distanceCalls = 0;
    FassTBench::nodesVisited = 0;
...
void FassT<T, distance>::Node::search(
    ...
    FassTBench::distanceCalls++;
    FassTBench::nodesVisited++;
